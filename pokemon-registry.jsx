...
const SETS = [
  ...
  { id: "jungle", name: "Jungle", name_fr: "Jungle", year: 1999, era: "Base", total: 64 },
  { id: "fossil", name: "Fossil", name_fr: "Fossile", year: 1999, era: "Base", total: 62 },
  { id: "base2", name: "Base Set 2", name_fr: "Édition de Base 2", year: 2000, era: "Base", total: 130 },
  { id: "team1", name: "Team Rocket", name_fr: "Team Rocket", year: 2000, era: "Base", total: 82 },
  { id: "gym1", name: "Gym Heroes", name_fr: "Arènes Héroïques", year: 2000, era: "Base", total: 132 },
  { id: "gym2", name: "Gym Challenge", name_fr: "Défi Arènes", year: 2001, era: "Base", total: 132 },
  // Neo Era (2000-2002)
  { id: "neo1", name: "Neo Genesis", name_fr: "Néo Genèse", year: 2000, era: "Neo", total: 111 },
  { id: "neo2", name: "Neo Discovery", name_fr: "Néo Découverte", year: 2000, era: "Neo", total: 75 },
  { id: "neo3", name: "Neo Revelation", name_fr: "Néo Révélation", year: 2001, era: "Neo", total: 66 },
  { id: "neo4", name: "Neo Destiny", name_fr: "Néo Destinée", year: 2001, era: "Neo", total: 105 },
  { id: "gsc", name: "Gold & Silver", name_fr: "Or & Argent", year: 2000, era: "Neo", total: 111 },
  { id: "lugia", name: "Lugia's Legend", name_fr: "Légende de Lugia", year: 2000, era: "Neo", total: 75 },
  { id: "aquapolis", name: "Aquapolis", name_fr: "Aquapolis", year: 2002, era: "Neo", total: 147 },
  { id: "skyridge", name: "Skyridge", name_fr: "Sommet Cristal", year: 2003, era: "Neo", total: 147 },
  // EX Era (2003-2007)
  { id: "rs", name: "Ruby & Sapphire", name_fr: "Rubis & Saphir", year: 2003, era: "EX", total: 109 },
  { id: "sandstorm", name: "Sandstorm", name_fr: "Tempête de Sable", year: 2003, era: "EX", total: 100 },
  { id: "mm", name: "Magma vs Aqua", name_fr: "Magma vs Aqua", year: 2004, era: "EX", total: 95 },
  { id: "firefury", name: "Fire Red Leaf Green", name_fr: "Rouge Feu Vert Feuille", year: 2004, era: "EX", total: 112 },
  { id: "rocket", name: "Team Rocket Returns", name_fr: "Retour de Team Rocket", year: 2004, era: "EX", total: 102 },
  { id: "deoxys", name: "Deoxys", name_fr: "Déoxys", year: 2005, era: "EX", total: 107 },
  { id: "emerald", name: "Emerald", name_fr: "Émeraude", year: 2005, era: "EX", total: 106 },
  { id: "unseen", name: "Unseen Forces", name_fr: "Forces Cachées", year: 2005, era: "EX", total: 115 },
  { id: "delta", name: "Delta Species", name_fr: "Espèces Delta", year: 2005, era: "EX", total: 113 },
  { id: "legend", name: "Legend Maker", name_fr: "Créateur de Légende", year: 2006, era: "EX", total: 92 },
  { id: "holon", name: "Holon Phantoms", name_fr: "Fantômes Holon", year: 2006, era: "EX", total: 110 },
  { id: "crystal", name: "Crystal Guardians", name_fr: "Gardiens Cristal", year: 2006, era: "EX", total: 100 },
  { id: "dragon", name: "Dragon Frontiers", name_fr: "Frontières Dragon", year: 2006, era: "EX", total: 101 },
  { id: "power", name: "Power Keepers", name_fr: "Gardiens du Pouvoir", year: 2007, era: "EX", total: 108 },
  // Diamond & Pearl Era (2006-2009)
  { id: "dp1", name: "Diamond & Pearl", name_fr: "Diamant & Perle", year: 2006, era: "D&P", total: 130 },
  { id: "mtg", name: "Mysterious Treasures", name_fr: "Trésors Mystérieux", year: 2007, era: "D&P", total: 123 },
  { id: "secret", name: "Secret Wonders", name_fr: "Merveilles Secrètes", year: 2007, era: "D&P", total: 132 },
  { id: "majestic", name: "Majestic Dawn", name_fr: "Aube Majestueuse", year: 2008, era: "D&P", total: 100 },
  { id: "legends", name: "Legends Awakened", name_fr: "Légendes Réveillées", year: 2008, era: "D&P", total: 146 },
  { id: "stormfront", name: "Stormfront", name_fr: "Avant-Garde Tempête", year: 2008, era: "D&P", total: 106 },
  { id: "platinum", name: "Platinum", name_fr: "Platine", year: 2009, era: "D&P", total: 127 },
  { id: "rising", name: "Rising Rivals", name_fr: "Rivaux Montants", year: 2009, era: "D&P", total: 111 },
  { id: "supreme", name: "Supreme Victors", name_fr: "Vainqueurs Suprêmes", year: 2009, era: "D&P", total: 147 },
  { id: "arceus", name: "Arceus", name_fr: "Arcéus", year: 2009, era: "D&P", total: 99 },
  // HeartGold & SoulSilver Era (2009-2010)
  { id: "hgss1", name: "HeartGold & SoulSilver", name_fr: "Cœur d'Or & Âme d'Argent", year: 2009, era: "HGSS", total: 123 },
  { id: "unleashed", name: "Unleashed", name_fr: "Déchaîné", year: 2010, era: "HGSS", total: 95 },
  { id: "undaunted", name: "Undaunted", name_fr: "Sans Peur", year: 2010, era: "HGSS", total: 90 },
  // Black & White Era (2010-2012)
  { id: "bw1", name: "Black & White", name_fr: "Noir & Blanc", year: 2010, era: "B&W", total: 114 },
  { id: "emerging", name: "Emerging Powers", name_fr: "Pouvoirs Naissants", year: 2011, era: "B&W", total: 98 },
  { id: "nvi", name: "Noble Victories", name_fr: "Victoires Nobles", year: 2011, era: "B&W", total: 101 },
  { id: "nxd", name: "Next Destinies", name_fr: "Destinées Futures", year: 2012, era: "B&W", total: 99 },
  { id: "dark", name: "Dark Explorers", name_fr: "Explorateurs de l'Ombre", year: 2012, era: "B&W", total: 108 },
  { id: "dragons", name: "Dragons Exalted", name_fr: "Dragons Exaltés", year: 2012, era: "B&W", total: 124 },
  { id: "boundaries", name: "Boundaries Crossed", name_fr: "Limites Franchies", year: 2012, era: "B&W", total: 149 },
  { id: "plasma-freeze", name: "Plasma Freeze", name_fr: "Dégel Plasma", year: 2013, era: "B&W", total: 116 },
  { id: "plasma-blast", name: "Plasma Blast", name_fr: "Explosion Plasma", year: 2013, era: "B&W", total: 101 },
  { id: "legendary", name: "Legendary Treasures", name_fr: "Trésors Légendaires", year: 2013, era: "B&W", total: 113 },
  // XY Era (2013-2016)
  { id: "xy1", name: "XY", name_fr: "XY", year: 2013, era: "XY", total: 146 },
  { id: "flashfire", name: "Flashfire", name_fr: "Feu Flash", year: 2014, era: "XY", total: 106 },
  { id: "furious", name: "Furious Fists", name_fr: "Fureur Fulgurante", year: 2014, era: "XY", total: 111 },
  { id: "phantom", name: "Phantom Forces", name_fr: "Forces Spectres", year: 2014, era: "XY", total: 119 },
  { id: "primal", name: "Primal Clash", name_fr: "Choc Primordial", year: 2015, era: "XY", total: 160 },
  { id: "roaring", name: "Roaring Skies", name_fr: "Cieux Rugissants", year: 2015, era: "XY", total: 108 },
  { id: "ancient", name: "Ancient Origins", name_fr: "Origines Antiques", year: 2015, era: "XY", total: 98 },
  { id: "breakpoint", name: "Breakpoint", name_fr: "Point de Rupture", year: 2015, era: "XY", total: 122 },
  { id: "breakthrough", name: "Breakthrough", name_fr: "Percée", year: 2015, era: "XY", total: 162 },
  { id: "generations", name: "Generations", name_fr: "Générations", year: 2016, era: "XY", total: 83 },
  { id: "fates", name: "Fates Collide", name_fr: "Destins Croisés", year: 2016, era: "XY", total: 124 },
  { id: "steam", name: "Steam Siege", name_fr: "Siège de Vapeur", year: 2016, era: "XY", total: 114 },
  // Sun & Moon Era (2016-2019)
  { id: "sm1", name: "Sun & Moon", name_fr: "Soleil & Lune", year: 2016, era: "S&M", total: 149 },
  { id: "guardians", name: "Guardians Rising", name_fr: "Gardiens Montants", year: 2017, era: "S&M", total: 145 },
  { id: "burning", name: "Burning Shadows", name_fr: "Brûlantes Ombres", year: 2017, era: "S&M", total: 147 },
  { id: "crimson", name: "Crimson Invasion", name_fr: "Invasion Écarlate", year: 2017, era: "S&M", total: 111 },
  { id: "ultra", name: "Ultra Prism", name_fr: "Ultra Prisme", year: 2018, era: "S&M", total: 156 },
  { id: "forbidden", name: "Forbidden Light", name_fr: "Lumière Interdite", year: 2018, era: "S&M", total: 131 },
  { id: "celestial", name: "Celestial Storm", name_fr: "Tempête Céleste", year: 2018, era: "S&M", total: 181 },
  { id: "lost", name: "Lost Thunder", name_fr: "Tonnerre Perdu", year: 2018, era: "S&M", total: 214 },
  { id: "team", name: "Team Up", name_fr: "Équipe Unie", year: 2019, era: "S&M", total: 181 },
  { id: "hidden", name: "Hidden Fates", name_fr: "Destinées Cachées", year: 2019, era: "S&M", total: 202 },
  // Sword & Shield Era (2019-2021)
  { id: "ss1", name: "Sword & Shield", name_fr: "Épée & Bouclier", year: 2019, era: "S&S", total: 202 },
  { id: "rebel", name: "Rebel Clash", name_fr: "Choc des Rebelles", year: 2020, era: "S&S", total: 192 },
  { id: "darkness", name: "Darkness Ablaze", name_fr: "Ténèbres Enflammées", year: 2020, era: "S&S", total: 189 },
  { id: "champions", name: "Champions Path", name_fr: "Sentier des Champions", year: 2020, era: "S&S", total: 198 },
  { id: "vivid", name: "Vivid Voltage", name_fr: "Tension Électrique", year: 2020, era: "S&S", total: 185 },
  { id: "shining", name: "Shining Fates", name_fr: "Destinées Éclatantes", year: 2021, era: "S&S", total: 198 },
  { id: "battle", name: "Battle Styles", name_fr: "Styles de Combat", year: 2021, era: "S&S", total: 183 },
  { id: "chilling", name: "Chilling Reign", name_fr: "Règne Glacial", year: 2021, era: "S&S", total: 198 },
  { id: "evolutions", name: "Evolutions Skies", name_fr: "Cieux Évolutifs", year: 2021, era: "S&S", total: 203 },
  // Scarlet & Violet Era (2022-2025)
  { id: "sv1", name: "Scarlet & Violet", name_fr: "Écarlate & Violet", year: 2022, era: "S&V", total: 198 },
  { id: "paldea", name: "Paldea Evolved", name_fr: "Paldéa Évoluée", year: 2023, era: "S&V", total: 193 },
  { id: "obsidian", name: "Obsidian Flames", name_fr: "Flammes Obsidiennes", year: 2023, era: "S&V", total: 207 },
  { id: "paradox", name: "Paradox Rift", name_fr: "Faille Paradoxe", year: 2023, era: "S&V", total: 182 },
  { id: "temporal", name: "Temporal Forces", name_fr: "Forces Temporelles", year: 2024, era: "S&V", total: 167 },
  { id: "prismatic", name: "Prismatic Evolutions", name_fr: "Évolutions Prismatiques", year: 2024, era: "S&V", total: 194 },
  { id: "surging", name: "Surging Sparks", name_fr: "Étincelles Montantes", year: 2024, era: "S&V", total: 182 },
  { id: "journey", name: "Journey Together", name_fr: "Voyage Ensemble", year: 2025, era: "S&V", total: 208 }
];
